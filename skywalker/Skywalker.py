...
class Processor(Iface, TProcessor):
  ...
  def process_get_provider_hash(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = get_provider_hash_result()
    result.success = yield gen.maybe_future(self._handler.get_provider_hash(args.provider))
  ...
  def process_get_identity_hash(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = get_identity_hash_result()
    result.success = yield gen.maybe_future(self._handler.get_identity_hash(args.identity))
  ...
  def process_get_instance(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = get_instance_result()
    result.success = yield gen.maybe_future(self._handler.get_instance(args.provider_hash, args.identity_hash, args.instance_uuid))
  ...
  def process_list_instances(self, seqid, iprot, oprot):
    ...
    result = list_instances_result()
    try:
      result.success = yield gen.maybe_future(self._handler.list_instances(args.provider_hash, args.identity_hash))
  ...
  def process_create_instance(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = create_instance_result()
    result.success = yield gen.maybe_future(self._handler.create_instance(args.provider_hash, args.identity_hash, args.options))
  ...
  def process_deploy_to_instance(self, seqid, iprot, oprot):
    ...
    result = deploy_to_instance_result()
    try:
      result.success = yield gen.maybe_future(self._handler.deploy_to_instance(args.provider_hash, args.identity_hash, args.options))
    except OpenStackException, oex:
      result.oex = oex
    except ConnectionException, cex:
      result.cex = cex
  ...
  def process_destroy_instance(self, seqid, iprot, oprot):
    ...
    result = destroy_instance_result()
    try:
      yield gen.maybe_future(self._handler.destroy_instance(args.provider_hash, args.identity_hash, args.instance_uuid))
    except OpenStackException, oex:
      result.oex = oex
    except ConnectionException, cex:
      result.cex = cex
